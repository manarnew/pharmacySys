<div x-data="{ showModal: false, isEditing: @entangle('isEditing') }"
    ...
    <div class="mb-6">
        <div>
            <h1 class="text-xl sm:text-2xl font-bold tracking-tight text-gray-900">Expenses</h1>
            <p class="mt-1 text-xs sm:text-sm text-gray-500">Track and manage your expenses.</p>
        </div>
    </div>
        ...
        function initDataTable() {
            ...
            $('#expensesTable').DataTable({
                ...
                initComplete: function() {
                    $('.dataTables_filter input').attr('placeholder', 'Search expenses...');
                }
            });
        }
