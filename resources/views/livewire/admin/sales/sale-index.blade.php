                    ...
                    @foreach($sales as $sale)
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="py-3 px-4 text-sm text-gray-700">
                                <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium {{ $sale->payment_type === 'bankak' ? 'bg-purple-100 text-purple-800' : 'bg-gray-100 text-gray-800' }}">
                            ...
                            <td class="py-3 px-4 text-center">
                                <div class="flex items-center justify-center gap-2">
                                    ...
                                    <button wire:click="delete({{ $sale->id }})" 
                                            wire:confirm="Are you sure? This will restore the stock." 
        ...
        function initDataTable() {
            ...
            $('#salesTable').DataTable({
                ...
                initComplete: function() {
                    $('.dataTables_filter input').attr('placeholder', 'Search sales...');
                }
            });
        }
