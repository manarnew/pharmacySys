<div x-data="{ showModal: false }"
    ...
    <div class="space-y-6">
        ...
        <div class="mb-6">
            <div>
                <h1 class="text-xl sm:text-2xl font-bold tracking-tight text-gray-900">User Roles</h1>
                <p class="mt-1 text-xs sm:text-sm text-gray-500">Manage user roles and assign permissions.</p>
            </div>
        </div>
        ...
        function initDataTable() {
            ...
            $('#rolesTable').DataTable({
                ...
                initComplete: function() {
                    $('.dataTables_filter input').attr('placeholder', 'Search roles...');
                }
            });
        }
